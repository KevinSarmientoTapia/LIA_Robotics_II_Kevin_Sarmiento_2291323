...
#include <Wire.h> // Includes the Wire.h libary to be used for the mpu

void mpu::begin(){ // initialize the mpu
...
int mpu::dataCount(){ // Counter value
...
void mpu::reset(){ // reset counter
  while(micros() - loop_timer < 4000); 
 //Reset the loop timer                                
 loop_timer = micros();
}

void mpu::setup_mpu_6050_registers(){ // setput mpu
...
void mpu::read_mpu_6050_data(){  // read mpu data
